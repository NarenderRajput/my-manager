...
<body>
    ...
    <div class="m-2 text-center">
        ...
        <div class="position-absolute-profile-div text-left w-25 h-75 ">
            <div>
                <img src="../images/profile-pic.webp" alt="" class="position-relative w-100 h-75">
                <h2 class="position-absolute-profilepic">Follow Crid</h2>
            </div>
            <div class="">
                <h4>About</h4>
